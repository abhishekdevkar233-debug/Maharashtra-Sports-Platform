  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Register under the appropriate category to access schemes, competitions, infrastructure and welfare programs of the Directorate of Sports & Youth Services, Maharashtra."
      />
      <SectionWrap>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {CATS.map(({ i: I, t, d, to }) => (
            <Link
              key={t}
              to={to}
              className="group rounded-2xl border border-gray-200 bg-white p-6 hover:border-[#363092] hover:shadow-[0_18px_40px_-20px_rgba(54,48,146,0.45)] hover:-translate-y-0.5 transition-all flex flex-col"
            >
