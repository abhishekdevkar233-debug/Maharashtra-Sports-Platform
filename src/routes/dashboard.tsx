...
const SERVICES = [
  ...
  { i: MessageSquareWarning, t: "Grievance Redressal", d: "Submit, track and manage grievances related to sports schemes, facilities and athlete services.", cta: "Raise Grievance", to: "/dashboard/grievance", color: "#FF6B35" },
  { i: Building2, t: "DSYS Complex", d: "Explore sports complexes, facilities, booking availability and infrastructure information.", cta: "Explore Complex", to: "/dashboard/fund-utilization", color: "#0d9488" },
  { i: GraduationCap, t: "Scholarship", d: "Apply and track scholarships, athlete benefits and sports excellence rewards.", cta: "Apply Now", to: "/dashboard/scholarship", color: "#7c3aed" },
];
