...
const VENUES = [
  { id: "shree-shiv-chhatrapati", n: "Shree Shiv Chhatrapati Sports Complex", l: "Balewadi, Pune", c: "55,000", f: ["Athletics","Football","Indoor halls"], img: vShivChhatrapati },
  { id: "dy-patil",               n: "DY Patil Stadium",                       l: "Navi Mumbai",  c: "55,000", f: ["Cricket","Football"], img: vDyPatil },
  { id: "wankhede",               n: "Wankhede Stadium",                        l: "Mumbai",       c: "33,000", f: ["Cricket"], img: vWankhede },
  { id: "vidarbha",               n: "Vidarbha Cricket Stadium",                l: "Nagpur",       c: "45,000", f: ["Cricket"], img: vVidarbha },
  { id: "mahalaxmi",              n: "Mahalaxmi Race Course Arena",             l: "Mumbai",       c: "20,000", f: ["Equestrian","Athletics"], img: vMahalaxmi },
  { id: "pune-football",          n: "Pune Football Arena",                     l: "Pune",         c: "12,000", f: ["Football"], img: vPuneFootball },
];
    ...
    <>
      ...
      <SectionWrap>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {VENUES.map(v => (
            <Link key={v.id} to="/stadiums-arenas/$id" params={{ id: v.id }}
              className="group rounded-2xl border border-gray-200 overflow-hidden bg-white hover:border-[#363092]/40 hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
              <div className="relative overflow-hidden" style={{ height: 180 }}>
                <img src={v.img} alt={v.n} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
              <div className="p-5">
                <h3 className="font-bold text-gray-900 group-hover:text-[#363092] transition-colors">{v.n}</h3>
                ...
                <div className="mt-4 flex items-center gap-1 text-xs font-semibold text-[#363092] group-hover:text-[#FF6B35] transition-colors">
                  Explore Venue <ArrowRight className="h-3 w-3 group-hover:translate-x-1 transition-transform" />
                </div>
              </div>
            </Link>
          ))}
      ...
      <SectionWrap alt>
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-4">
          <div>
            ...
            <p className="mt-2 text-gray-500 max-w-lg">Explore sports facilities across all 36 districts of Maharashtra — filter by facility type, region and more.</p>
          </div>
