      ...
      <TableWrap heads={["Asset ID","Item Name","Category","Total Qty","Good","Damaged","Hostel","Est. Value","Action"]}>
        {filtered.map((a, i) => (
          <tr key={i} className="hover:bg-gray-50 transition">
            ...
            <td className="px-5 py-3.5">
              <div className="flex gap-1.5">
                <button className="h-7 w-7 rounded-full border border-gray-200 grid place-items-center text-gray-400 hover:text-blue-600 hover:border-blue-300 transition"><Edit3 className="h-3.5 w-3.5" /></button>
                <button className="h-7 w-7 rounded-full border border-gray-200 grid place-items-center text-gray-400 hover:text-red-500 hover:border-red-300 transition"><Trash2 className="h-3.5 w-3.5" /></button>
              </div>
            </td>
          </tr>
        ))}
        ...
        <div className="flex items-center gap-2.5 px-3 py-4 border-b border-gray-100 min-h-[64px]">
          ...
          {!collapsed && (
            <div className="min-w-0">
              <div className="font-black text-gray-900 text-[11px] leading-tight">Hostel Management System</div>
            </div>
          )}
