        ...
        <div className="flex items-center gap-2.5 px-3 py-4 border-b border-gray-100 min-h-[64px]">
          ...
          {!collapsed && (
            <div className="min-w-0">
              <div className="font-black text-gray-900 text-sm leading-none">SSCM Portal</div>
              <div className="text-[10px] text-gray-400 mt-0.5">Scholarship & Certificates</div>
            </div>
          )}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 bg-white border-b border-gray-100 flex items-center px-5 gap-4 sticky top-0 z-20 shadow-sm">
          ...
          <div className="text-sm text-gray-500">
            <span className="font-black text-gray-900 cursor-pointer hover:text-blue-600 transition" onClick={() => setNav("dashboard")}>SSCM Portal</span>
