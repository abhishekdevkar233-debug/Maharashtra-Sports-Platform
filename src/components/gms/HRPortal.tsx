            ...
            <tr key={i} onClick={() => setSelected(employees.indexOf(e))}
              ...
              <td className="px-5 py-3.5">
                <div className="flex gap-1.5">
                  <button className="h-7 w-7 rounded-full border border-gray-200 grid place-items-center text-gray-400 hover:text-cyan-600 hover:border-cyan-300 transition"><Eye className="h-3.5 w-3.5" /></button>
        ...
        <div className="flex items-center gap-2.5 px-3 py-4 border-b border-gray-100 min-h-[64px]">
          ...
          {!collapsed && (
            <div className="min-w-0">
              <div className="font-black text-gray-900 text-[11px] leading-tight">Human Resource Management</div>
            </div>
          )}
